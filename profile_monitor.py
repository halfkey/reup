...
class ProfileMonitor(BaseMonitor):
    ...
    def create_control_panel(self):
        ...
        title = f" {self.profile_name} Controls " if self.is_profile else " Task Controls "
    ...
    def create_log_frame(self):
        ...
        log_frame = ttk.LabelFrame(self, text=" Activity Log ", style='Custom.TLabelframe')
    ...
    def check_product(self, url: str) -> None:
        ...
        try:
            ...
            product['scheduled_check'] = self.after(interval_ms, lambda: self.check_product(url))
    ...
    def _update_product_state(self, url: str, name: str, is_available: bool, 
                            details: Dict, current_time: str) -> None:
        """Update product state and UI efficiently."""
        try:
            status = f"In Stock ({details['stock']})" if is_available else "Out of Stock"
