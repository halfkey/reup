...
class StockMonitorGUI:
    ...
    def setup_styles(self):
        ...
        self.style.configure(
            "Header.TLabel", font=("Arial", 12, "bold"), background="#f0f0f0"
        )
    ...
    def create_profile_section(self):
        ...
        frame = ttk.LabelFrame(
            self.setup_tab, text=" Profile Management ", style="Custom.TLabelframe"
        )
    ...
    def create_search_section(self):
        ...
        frame = ttk.LabelFrame(
            self.setup_tab, text=" Product Search ", style="Custom.TLabelframe"
        )
        frame.pack(fill=tk.X, padx=10, pady=5)
    ...
    def create_product_list(self):
        ...
        product_frame = ttk.LabelFrame(
            self.setup_tab, text=" Products ", style="Custom.TLabelframe"
        )
    ...
    def save_current_profile(self):
        ...
        try:
            ...
            for item in self.product_tree.get_children():
                ...
                products.append({"name": values[0], "url": values[1]})
    ...
    def start_profile_monitoring(self):
        ...
        try:
            ...
            messagebox.showinfo(
                "Success", f"Started monitoring profile '{profile_name}'"
            )
    ...
    def perform_search(self):
        ...
        try:
            ...
            # Perform search
            results = self.search_manager.search_products(self.store_var.get(), query)
    ...
    def start_task_monitoring(self):
        ...
        try:
            ...
            existing_tasks = [
                name for name in self.monitor_tabs.keys() if name.startswith("Task ")
            ]
            next_num = 1
    ...
    def display_search_results(self, results: List[Dict]):
        ...
        self.search_results = {
            result["display_name"]: result["url"] for result in results
        }
    ...
    def add_selected_products(self, tree, window):
        ...
        if added_count > 0:
            ...
            messagebox.showwarning(
                "No Selection", "Please select at least one product to add"
            )
    ...
    def add_product_to_monitor(self, url: str) -> ProductMonitor:
        ...
        try:
            ...
            item = self.product_tree.insert(
                "", "end", values=(name, url, "Not Monitoring", "▶")  # Start button
            )
    ...
    def create_found_products_section(self):
        ...
        frame = ttk.LabelFrame(
            self.setup_tab, text=" Found In Stock ", style="Custom.TLabelframe"
        )
