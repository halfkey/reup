...
def test_profile_operations(root, mock_api, monkeypatch):
    ...
    app.profile_manager.load_profile = MagicMock(return_value={
        'name': 'test_profile',
    ...
    app.product_tree.item.return_value = {
        'values': ['Test Product', 'https://www.bestbuy.ca/en-ca/product/12345', 'InStock', '⏹', '']
    }
    app.monitor_tabs = {}
    ...
    with patch('tkinter.messagebox.showinfo'), \
        ...
        try:
            ...
            app.profile_manager.load_profile.assert_called_once_with('test_profile')  # Verify called with correct name
